...
export const Button: FC<PropsWithChildren<ButtonProps>> = ({
  ...
  const baseClasses =
    "inline-flex items-center justify-center px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";

  const variantClasses = {
    primary:
      "bg-neutral-700 text-white hover:bg-neutral-600 focus:ring-neutral-400",
    secondary:
...
export const Textarea: FC<TextareaProps> = ({
  ...
  const baseClasses =
    "block w-full px-3 py-2 border border-slate-200 rounded-md placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500 disabled:bg-slate-50 disabled:text-slate-500 resize-vertical";
  const classes = `${baseClasses} ${className}`;
